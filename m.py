...
bot = telebot.TeleBot('7061963025:AAGtZCeJziXaymxY36vBqsV7vqAkxMWjg1A')
...
def handle_bgmi(message):
    ...
    if user_id in allowed_user_ids:
        ...
        if len(command) == 4:  # Updated to accept target, time, and port
            ...
            response = "Usage :- /bgmi <target> <port> <time>\npaid by :- @PARADOX_SIR"  # Updated command syntax
    else:
...
♻️ BGMI 3.2 DDoS SERVER FREEZE FULL SAFE 💯% ♻️
